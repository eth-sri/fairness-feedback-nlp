...
if __name__ == "__main__":
    ...
    for target_label, remove_label in [(0,1),(1,0),(4,5),(5,4),(8,10),(10,8),(15,16),(16,15)]:
        ...
        generate(model_type="GPT3", removal_mode="drop_thresh", q="mean", remove_label=remove_label,
                 target_label=target_label, n_beams=5, max_length=64,max_generations=1000000,
                 batch_size=32, total_items=100, add_successes_only=True, overwrite_labels=True,
                 ...
                 gpt_mode="davinci_postprocess", word_replacement_mode="Full",
                 eval_classifier_path=args.source_folder+"/Roberta_Kaggle_64", attention_layer=10,
                 save=args.source_folder+"/gpt_edit_pairs/" + str(remove_label) + "_" + str(target_label))
    for target_label in [0,1,2,4,5,8,9,10,11,12,13,15,16,17,18]:
        for remove_label in [0,1,2,4,5,8,9,10,11,12,13,15,16,17,18]:
            ...
            generate(model_type="GPT3",removal_mode="drop_thresh",q="mean",remove_label=remove_label,target_label=target_label,n_beams=5,max_length=64,
                     ...
                     classifier_path=args.source_folder+"/Roberta_Kaggle_64",add_label=True,gpt_mode="davinci_postprocess",word_replacement_mode="Full",
                     eval_classifier_path=args.source_folder+"/Roberta_Kaggle_64",attention_layer=10,save=args.source_folder+"/gpt_edit_pairs/"+str(remove_label)+"_"+str(target_label))